...
namespace Vital.DataLayer.DatabaseSpecific
{
	...
	public partial class DataAccessAdapter : DataAccessAdapterBase
	{
        ...
        public IFieldPersistenceInfo GetEntityFieldPersistenceInfo(IEntityField2 field)
        {
            // Access & return the protected method to retrieve the field's info
            return GetFieldPersistenceInfo(field);
        }
		// __LLBLGENPRO_USER_CODE_REGION_END
		#endregion
