...
namespace Vital.DataLayer.FactoryClasses
{
	...
	{
		private static readonly Dictionary<Vital.DataLayer.EntityType, string> _entityTypeNamesCache = new Dictionary<Vital.DataLayer.EntityType, string>();

		/// <summary>static ctor which initializes the static entity type cache.</summary>
		static EntityFieldsFactory()
		{
			foreach(Vital.DataLayer.EntityType value in Enum.GetValues(typeof(Vital.DataLayer.EntityType)))
			{
				_entityTypeNamesCache.Add(value, Enum.GetName(typeof(Vital.DataLayer.EntityType), value));
			}
		}	
		...
		public static IEntityFields2 CreateEntityFieldsObject(Vital.DataLayer.EntityType relatedEntityType)
		{
