...
namespace Vital.DataLayer.RelationClasses
{
	...
	public partial class InvoiceRelations
	{
		...
		/// <summary>Returns a new IEntityRelation object, between InvoiceEntity and TestEntity over the m:1 relation they have, using the relation between the fields:
	...
	{
		internal static readonly IEntityRelation TestEntityUsingTestIdStatic = new InvoiceRelations().TestEntityUsingTestId;
		internal static readonly IEntityRelation UserEntityUsingUserIdStatic = new InvoiceRelations().UserEntityUsingUserId;
