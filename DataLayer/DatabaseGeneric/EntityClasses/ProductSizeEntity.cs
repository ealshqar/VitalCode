...
namespace Vital.DataLayer.EntityClasses
{
	...
	/// <summary>Entity class which represents the entity 'ProductSize'.<br/><br/></summary>
	[Serializable]
	public partial class ProductSizeEntity : CommonEntityBase
		...
		// __LLBLGENPRO_USER_CODE_REGION_END	
	{
		...
		static ProductSizeEntity()
		{
			SetupCustomPropertyHashtables();
		}
		
		/// <summary> CTor</summary>
		public ProductSizeEntity():base("ProductSizeEntity")
		{
		...
		public ProductSizeEntity(IEntityFields2 fields):base("ProductSizeEntity")
		{
			InitClassEmpty(null, fields);
		}

		/// <summary> CTor</summary>
		/// <param name="validator">The custom validator object for this ProductSizeEntity</param>
		public ProductSizeEntity(IValidator validator):base("ProductSizeEntity")
		{
			InitClassEmpty(validator, null);
		}
				
		/// <summary> CTor</summary>
		/// <param name="id">PK value for ProductSize which data should be fetched into this ProductSize object</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProductSizeEntity(System.Int32 id):base("ProductSizeEntity")
		{
			InitClassEmpty(null, null);
			this.Id = id;
		}
		...
		/// <param name="validator">The custom validator object for this ProductSizeEntity</param>
		/// <remarks>The entity is not fetched by this constructor. Use a DataAccessAdapter for that.</remarks>
		public ProductSizeEntity(System.Int32 id, IValidator validator):base("ProductSizeEntity")
		{
			InitClassEmpty(validator, null);
			this.Id = id;
		}
		...
		protected ProductSizeEntity(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		...
		{
			switch((ProductSizeFieldIndex)fieldIndex)
			{
				case ProductSizeFieldIndex.UserId:
					DesetupSyncUser(true, false);
					break;
				case ProductSizeFieldIndex.ProductFormsId:
					DesetupSyncProductForm(true, false);
					break;
				case ProductSizeFieldIndex.StatusLookupsId:
		...
		internal static RelationCollection GetRelationsForField(string fieldName)
		{
			...
			{
				case "Status":
					toReturn.Add(Relations.LookupEntityUsingStatusLookupsId);
					break;
				case "ProductForm":
				...
				case "User":
					...
					break;
				case "AutoTestResultProducts":
					toReturn.Add(Relations.AutoTestResultProductEntityUsingProductSizesId);
					break;
				default:
					break;				
			}
		...
		{
			return new ProductSizeRelations().GetAllRelations();
		}
		...
		public virtual IRelationPredicateBucket GetRelationInfoAutoTestResultProducts()
		{
			...
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(AutoTestResultProductFields.ProductSizesId, null, ComparisonOperator.Equal, this.Id));
			return bucket;
		}
		...
		{
			IRelationPredicateBucket bucket = new RelationPredicateBucket();
			bucket.PredicateExpression.Add(new FieldCompareValuePredicate(LookupFields.Id, null, ComparisonOperator.Equal, this.StatusLookupsId));
			return bucket;
		}
		...
		{
			return EntityFactoryCache2.GetEntityFactory(typeof(ProductSizeEntityFactory));
		}
#if !CF
		...
		private static void SetupCustomPropertyHashtables()
		{
			...
			fieldHashtable = new Dictionary<string, string>();
			_fieldsCustomProperties.Add("StatusLookupsId", fieldHashtable);
			fieldHashtable = new Dictionary<string, string>();
		...
		{
			this.PerformDesetupSyncRelatedEntity( _status, new PropertyChangedEventHandler( OnStatusPropertyChanged ), "Status", Vital.DataLayer.RelationClasses.StaticProductSizeRelations.LookupEntityUsingStatusLookupsIdStatic, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)ProductSizeFieldIndex.StatusLookupsId } );
			_status = null;
		}
		...
		private void SetupSyncStatus(IEntityCore relatedEntity)
		{
			if(_status!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _status, new PropertyChangedEventHandler( OnStatusPropertyChanged ), "Status", Vital.DataLayer.RelationClasses.StaticProductSizeRelations.LookupEntityUsingStatusLookupsIdStatic, true, new string[] {  } );
			}
		}
		...
		private void SetupSyncProductForm(IEntityCore relatedEntity)
		{
			if(_productForm!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _productForm, new PropertyChangedEventHandler( OnProductFormPropertyChanged ), "ProductForm", Vital.DataLayer.RelationClasses.StaticProductSizeRelations.ProductFormEntityUsingProductFormsIdStatic, true, new string[] {  } );
			}
		}
		...
		{
			this.PerformDesetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", Vital.DataLayer.RelationClasses.StaticProductSizeRelations.UserEntityUsingUserIdStatic, true, signalRelatedEntity, "", resetFKFields, new int[] { (int)ProductSizeFieldIndex.UserId } );
			_user = null;
		}
		...
		private void SetupSyncUser(IEntityCore relatedEntity)
		{
			if(_user!=relatedEntity)
			{
				...
				this.PerformSetupSyncRelatedEntity( _user, new PropertyChangedEventHandler( OnUserPropertyChanged ), "User", Vital.DataLayer.RelationClasses.StaticProductSizeRelations.UserEntityUsingUserIdStatic, true, new string[] {  } );
			}
		}
		...
		/// <param name="validator">The validator object for this ProductSizeEntity</param>
		...
		public  static ProductSizeRelations Relations
		{
			get	{ return new ProductSizeRelations(); }
		}
		...
		{
			get	{ return new PrefetchPathElement2( new EntityCollection<AutoTestResultProductEntity>(EntityFactoryCache2.GetEntityFactory(typeof(AutoTestResultProductEntityFactory))), (IEntityRelation)GetRelationsForField("AutoTestResultProducts")[0], (int)Vital.DataLayer.EntityType.ProductSizeEntity, (int)Vital.DataLayer.EntityType.AutoTestResultProductEntity, 0, null, null, null, null, "AutoTestResultProducts", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.OneToMany);	}
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(LookupEntityFactory))),	(IEntityRelation)GetRelationsForField("Status")[0], (int)Vital.DataLayer.EntityType.ProductSizeEntity, (int)Vital.DataLayer.EntityType.LookupEntity, 0, null, null, null, null, "Status", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(ProductFormEntityFactory))),	(IEntityRelation)GetRelationsForField("ProductForm")[0], (int)Vital.DataLayer.EntityType.ProductSizeEntity, (int)Vital.DataLayer.EntityType.ProductFormEntity, 0, null, null, null, null, "ProductForm", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		{
			get	{ return new PrefetchPathElement2(new EntityCollection(EntityFactoryCache2.GetEntityFactory(typeof(UserEntityFactory))),	(IEntityRelation)GetRelationsForField("User")[0], (int)Vital.DataLayer.EntityType.ProductSizeEntity, (int)Vital.DataLayer.EntityType.UserEntity, 0, null, null, null, null, "User", SD.LLBLGen.Pro.ORMSupportClasses.RelationType.ManyToOne); }
		}
		...
		/// <summary> The Id property of the Entity ProductSize<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductSizes"."ProductSizes_Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, true, true</remarks>
		public virtual System.Int32 Id
		{
			get { return (System.Int32)GetValue((int)ProductSizeFieldIndex.Id, true); }
			set	{ SetValue((int)ProductSizeFieldIndex.Id, value); }
		}

		/// <summary> The UserId property of the Entity ProductSize<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductSizes"."User_Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 UserId
		{
			get { return (System.Int32)GetValue((int)ProductSizeFieldIndex.UserId, true); }
			set	{ SetValue((int)ProductSizeFieldIndex.UserId, value); }
		}

		/// <summary> The ProductFormsId property of the Entity ProductSize<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductSizes"."ProductForms_Id"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 ProductFormsId
		{
			get { return (System.Int32)GetValue((int)ProductSizeFieldIndex.ProductFormsId, true); }
			set	{ SetValue((int)ProductSizeFieldIndex.ProductFormsId, value); }
		}

		/// <summary> The StatusLookupsId property of the Entity ProductSize<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductSizes"."Status_LookupId"<br/>
		/// Table field type characteristics (type, precision, scale, length): Int, 10, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Int32 StatusLookupsId
		{
			get { return (System.Int32)GetValue((int)ProductSizeFieldIndex.StatusLookupsId, true); }
			set	{ SetValue((int)ProductSizeFieldIndex.StatusLookupsId, value); }
		}

		/// <summary> The Size property of the Entity ProductSize<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductSizes"."ProductSizes_Size"<br/>
		/// Table field type characteristics (type, precision, scale, length): NVarChar, 0, 0, 2147483647<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.String Size
		{
			get { return (System.String)GetValue((int)ProductSizeFieldIndex.Size, true); }
			set	{ SetValue((int)ProductSizeFieldIndex.Size, value); }
		}

		/// <summary> The Price property of the Entity ProductSize<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductSizes"."ProductSizes_Price"<br/>
		/// Table field type characteristics (type, precision, scale, length): Decimal, 19, 4, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.Decimal Price
		{
			get { return (System.Decimal)GetValue((int)ProductSizeFieldIndex.Price, true); }
			set	{ SetValue((int)ProductSizeFieldIndex.Price, value); }
		}

		/// <summary> The CreationDateTime property of the Entity ProductSize<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductSizes"."ProductSizes_CreationDateTime"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime CreationDateTime
		{
			get { return (System.DateTime)GetValue((int)ProductSizeFieldIndex.CreationDateTime, true); }
			set	{ SetValue((int)ProductSizeFieldIndex.CreationDateTime, value); }
		}

		/// <summary> The UpdatedDateTime property of the Entity ProductSize<br/><br/></summary>
		/// <remarks>Mapped on  table field: "ProductSizes"."ProductSizes_UpdatedDateTime"<br/>
		/// Table field type characteristics (type, precision, scale, length): DateTime, 0, 0, 0<br/>
		/// Table field behavior characteristics (is nullable, is PK, is identity): false, false, false</remarks>
		public virtual System.DateTime UpdatedDateTime
		{
			get { return (System.DateTime)GetValue((int)ProductSizeFieldIndex.UpdatedDateTime, true); }
			set	{ SetValue((int)ProductSizeFieldIndex.UpdatedDateTime, value); }
		}
		...
		{
			get { return GetOrCreateEntityCollection<AutoTestResultProductEntity, AutoTestResultProductEntityFactory>("ProductSize", true, false, ref _autoTestResultProducts);	}
		}
		...
		public virtual ProductFormEntity ProductForm
		{
			...
			set
			{
				...
				{
					SetSingleRelatedEntityNavigator(value, "ProductSizes", "ProductForm", _productForm, true); 
				}
			}
		}
		...
		{ 
			get { return (int)Vital.DataLayer.EntityType.ProductSizeEntity; }
		}
