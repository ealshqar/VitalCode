...
{
    public partial class XtraReportReportHeader : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReportReportHeader()
        {
            InitializeComponent();
        }
        ...
        private void xrPictureBoxLogo_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (pb != null && pb.Image != null)
            {
                try
                {
                    var reportUnit = ((DevExpress.XtraReports.UI.XtraReport)pb.Report).ReportUnit;
