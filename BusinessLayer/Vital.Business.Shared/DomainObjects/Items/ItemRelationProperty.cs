...
{
    public class ItemRelationProperty : DomainEntityPropertyRelational, IDXDataErrorInfo
    {
        #region Private Variables

        private ItemRelation _itemRelation;
        ...
        public void GetPropertyError(string propertyName, ErrorInfo info)
        {
            ...
            else if ((propertyName == ExpressionHelper.GetPropertyName(() => ItemRelation) && !ItemRelation.Validate()))
            {
                info.ErrorText = StaticKeys.ValidationMessageBlankField;
                info.ErrorType = ErrorType.Critical;
            }
